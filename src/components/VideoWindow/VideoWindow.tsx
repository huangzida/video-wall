...
export function VideoWindow({
  ...
  const streamType = useMemo(
    () => detectStreamType(window.streamUrl),
    [window.streamUrl],
  );
  ...
  return (
    <div
      ...
      style={{
        ...
        transition: isResizing ? "none" : "box-shadow 0.2s ease, border 0.2s ease, height 0.2s ease",
        ...
        <>
          <div
            ...
            style={{
              ...
              opacity: 0.8,
              boxShadow:
                "0 2px 8px rgba(99, 102, 241, 0.3), 0 0 1px rgba(99, 102, 241, 0.5) inset",
              transition: "opacity 0.15s ease, transform 0.15s ease",
            }}
            onMouseEnter={(e) => {
              e.currentTarget.style.opacity = "1";
              e.currentTarget.style.transform = "translateX(-50%) scaleX(1.1)";
            }}
            onMouseLeave={(e) => {
          ...
          <div
            ...
            style={{
              ...
              height: 6,
              background:
                "linear-gradient(0deg, rgba(99, 102, 241, 0.9) 0%, rgba(99, 102, 241, 0.4) 100%)",
          ...
          <div
            ...
            style={{
              ...
              height: 48,
              background:
                "linear-gradient(90deg, rgba(99, 102, 241, 0.9) 0%, rgba(99, 102, 241, 0.4) 100%)",
              borderRadius: "6px 0 0 6px",
              cursor: "ew-resize",
              opacity: 0.8,
              boxShadow:
                "-2px 0 8px rgba(99, 102, 241, 0.3), 0 0 1px rgba(99, 102, 241, 0.5) inset",
              transition: "opacity 0.15s ease, transform 0.15s ease",
            }}
            onMouseEnter={(e) => {
              e.currentTarget.style.opacity = "1";
          ...
          <div
            ...
            style={{
              ...
              height: 48,
              background:
                "linear-gradient(270deg, rgba(99, 102, 241, 0.9) 0%, rgba(99, 102, 241, 0.4) 100%)",
          ...
          <div
            ...
            style={{
              ...
              height: 16,
              background:
                "radial-gradient(circle at 30% 30%, rgba(99, 102, 241, 1) 0%, rgba(99, 102, 241, 0.6) 50%, rgba(99, 102, 241, 0.2) 100%)",
          ...
          <div
            ...
            style={{
              ...
              height: 16,
              background:
                "radial-gradient(circle at 70% 30%, rgba(99, 102, 241, 1) 0%, rgba(99, 102, 241, 0.6) 50%, rgba(99, 102, 241, 0.2) 100%)",
          ...
          <div
            ...
            style={{
              ...
              height: 16,
              background:
                "radial-gradient(circle at 30% 70%, rgba(99, 102, 241, 1) 0%, rgba(99, 102, 241, 0.6) 50%, rgba(99, 102, 241, 0.2) 100%)",
          ...
          <div
            ...
            style={{
              ...
              height: 16,
              background:
                "radial-gradient(circle at 70% 70%, rgba(99, 102, 241, 1) 0%, rgba(99, 102, 241, 0.6) 50%, rgba(99, 102, 241, 0.2) 100%)",
